...
{
    int bNameApply = true;    //< true - apply to name, false - apply to comment
    int bReplace = true;      //< replace the existing name or comment
    int bVerbose = false;      //< show detail messages
};
